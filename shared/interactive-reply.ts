...
export const INTERACTIVE_REPLY_PROMPT = `\n\nInteractive replies (desktop/web): when choices, comparisons, a diagram, or a small local tool would help, compose a tailored UI with OpenUI Lang inside a fenced openmaus-ui block. Also give a short useful plain-text summary outside the block for other clients. Do not force a visualization into simple answers. This is a composable engine, not a collection of fixed layouts.

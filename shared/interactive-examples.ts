...
$notes = "";
root = Card("What should we do next?", [Text("Choose a direction and add any details. You can edit the reply before sending."), Choice("Next step", ["Review the approach", "Implement the change", "Compare alternatives"], $depth), Input("Anything to focus on?", $notes), Draft($depth + ". " + $notes)]);`;

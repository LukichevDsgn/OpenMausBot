...
9. Advance the custom v23 baseline and tag only after the verified swap.

The official installer never runs over the custom v23 build. Merging is never

...
Ten selectable body shapes for the mascot, per bot, identical on desktop and phone.
...
Not in scope: parametric sliders, custom SVG upload, surface styles, face
variants, accessories. The shape is the only thing that varies.
